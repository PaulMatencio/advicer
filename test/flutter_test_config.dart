import 'dart:async';
import 'package:file/file.dart'; // FileSystem()
import 'package:file/local.dart'; //  LocalFileSystem()   extends FileSystem()
...
Future<void> testExecutable(FutureOr<void> Function() testMain) async {
  setUpAll(() async {
    ...
    final robotFont = _loadMaterialFont('Roboto-Regular.ttf');
    ...
    final FontLoader fontLoader = FontLoader('Roboto')..addFont(robotFont);
...
Future<ByteData> _loadMaterialFont(String fontName) async {
  ...
  final Directory flutterRoot =
      localFs.directory(platform.environment['FLUTTER_ROOT']);
